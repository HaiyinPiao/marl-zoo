...
parser.add_argument('--env-name', default="PredatorPrey7x7-v0", metavar='G',
...
parser.add_argument('--learning-rate', type=float, default=4e-4, metavar='G',
...
optim_epochs = 10
optim_batch_size = int(args.min_batch_size/4)